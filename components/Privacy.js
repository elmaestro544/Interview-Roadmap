        ...
        sections: [
            {
                ...
                content: [
                    "Interview Roadmap ('we', 'us', or 'our') is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our Service. Please read this privacy policy carefully. If you do not agree with the terms of this privacy policy, please do not access the site."
                ]
            },
            {
                ...
                content: [
                    ...
                    React.createElement('ul', { className: 'list-disc list-inside space-y-2 pl-4' },
                        ...
                        React.createElement('li', null, React.createElement('strong', null, 'User Content: '), "We collect the files and content you upload to our services to provide you with the features of the application, such as the Interview Roadmap assessment tools.")
                    )
                ]
            },
            {
        ...
        sections: [
            {
                title: "1. مقدمة",
                content: [
                    "تلتزم 'خارطة طريق المقابلة' ('نحن' أو 'لنا') بحماية خصوصيتك. تشرح سياسة الخصوصية هذه كيف نجمع معلوماتك ونستخدمها ونكشف عنها ونحميها عند استخدامك لخدمتنا. يرجى قراءة سياسة الخصوصية هذه بعناية. إذا كنت لا توافق على شروط سياسة الخصوصية هذه، فيرجى عدم الوصول إلى الموقع."
                ]
            },
            {
                ...
                content: [
                    ...
                    React.createElement('ul', { className: 'list-disc list-inside space-y-2 pr-4' },
                        ...
                        React.createElement('li', null, React.createElement('strong', null, 'محتوى المستخدم: '), "نجمع الملفات والمحتوى الذي تقوم بتحميله إلى خدماتنا لتزويدك بميزات التطبيق، مثل أدوات تقييم خارطة طريق المقابلة.")
                    )
                ]
            },
            {
