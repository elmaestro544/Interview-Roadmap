        ...
        sections: [
            {
                ...
                content: [
                    "Welcome to Interview Roadmap ('we', 'us', or 'our'). These Terms and Conditions govern your use of our website and services (collectively, the 'Service'). By accessing or using the Service, you agree to be bound by these Terms. If you disagree with any part of the terms, you may not access the Service."
                ]
            },
            {
            ...
            },
            {
                ...
                content: [
                    "The Service and its original content (excluding Content provided by users), features, and functionality are and will remain the exclusive property of Interview Roadmap and its licensors. The Service is protected by copyright, trademark, and other laws of both the United States and foreign countries."
                ]
            },
            {
                title: "6. Termination",
            ...
            },
            {
                ...
                content: [
                    ...
                    "In no case shall Interview Roadmap, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, service providers or licensors be liable for any injury, loss, claim, or any direct, indirect, incidental, punitive, special, or consequential damages of any kind."
                ]
            },
            {
        ...
        sections: [
            {
                title: "1. مقدمة",
                content: [
                    "أهلاً بك في 'خارطة طريق المقابلة' (المشار إليه بـ 'نحن' أو 'لنا'). تحكم هذه الشروط والأحكام استخدامك لموقعنا وخدماتنا (يشار إليها مجتمعة بـ 'الخدمة'). من خلال الوصول إلى الخدمة أو استخدامها، فإنك توافق على الالتزام بهذه الشروط. إذا كنت لا توافق على أي جزء من الشروط، فلا يجوز لك الوصول إلى الخدمة."
                ]
            },
            {
            ...
            },
            {
                ...
                content: [
                    "الخدمة ومحتواها الأصلي (باستثناء المحتوى المقدم من قبل المستخدمين) والميزات والوظائف هي وستبقى ملكية حصرية لـ 'خارطة طريق المقابلة' ومرخصيه. الخدمة محمية بموجب حقوق النشر والعلامات التجارية والقوانين الأخرى في كل من الولايات المتحدة والدول الأجنبية."
                ]
            },
            {
                title: "6. الإنهاء",
            ...
            },
            {
                ...
                content: [
                    ...
                    "لا يتحمل 'خارطة طريق المقابلة' أو مديرونا أو موظفونا أو الشركات التابعة لنا أو وكلائنا أو مقاولونا أو متدربونا أو موردونا أو مقدمو الخدمات أو المرخصون بأي حال من الأحوال المسؤولية عن أي إصابة أو خسارة أو مطالبة أو أي أضرار مباشرة أو غير مباشرة أو عرضية أو تأديبية أو خاصة أو تبعية من أي نوع."
                ]
            },
            {
